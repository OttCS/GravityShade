...
void main() {
	...
	trueLight = 0.2f + max(trueLight * pow(lmcoord.g, Skylight_Falloff + rainStrength * lmcoord.g), vec3(1.7f, 1.3f, 1.0f) * pow(lmcoord.r, Blocklight_Falloff + rainStrength * lmcoord.g)); // Mix with blocklight
